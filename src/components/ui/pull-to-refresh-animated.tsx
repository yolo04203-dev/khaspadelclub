...
interface PullToRefreshAnimatedProps {
...
const PullToRefreshAnimated = React.forwardRef<HTMLDivElement, PullToRefreshAnimatedProps>(
  function PullToRefreshAnimated({ children, onRefresh, className, disabled = false }, ref) {
...
export default PullToRefreshAnimated;
