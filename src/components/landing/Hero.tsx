...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[90svh] flex items-center overflow-hidden pt-24 sm:pt-28">
      {/* Background gradient */}
      ...
      <div className="container relative z-10 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-primary-foreground hero-animate">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 mb-8 max-w-lg">The ultimate leaderboard platform. Track rankings, challenge teams, and compete in real-time.
