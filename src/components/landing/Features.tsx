    ...
    <section className="py-24 bg-secondary/30">
      <div className="container">
        <motion.div
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">A complete platform for managing padel sports competitions, from casual matches to organized tournaments.
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <motion.div
            ...
            className="group p-6 bg-card rounded-xl border border-border shadow-card hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
